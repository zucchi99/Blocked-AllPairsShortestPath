...
//main device code
void floyd_warshall_blocked_device_v_4_1(int *matrix, int n, int B);

//rounds code
__global__ void execute_round_device_v_4_1_phase_1(int *matrix, int n, int t, bool handle_bank_conflict);

__global__ void execute_round_device_v_4_1_phase_2_row_portion(int *matrix, int n, int t, int start_col, int end_col);
__global__ void execute_round_device_v_4_1_phase_2_col_portion(int *matrix, int n, int t, int start_row, int end_row);
__global__ void execute_round_device_v_4_1_phase_3_portion(int *matrix, int n, int t, int start_row, int start_col, int end_row, int end_col);


int main(int argc, char *argv[]) {

    return handle_arguments_and_execute(argc, argv, (void(*) (int*, int, int)) &floyd_warshall_blocked_device_v_4_1);
}
...
void floyd_warshall_blocked_device_v_4_1(int *matrix, int n, int B) {
    ...
    for(int t = 0; t < num_rounds; t++) { 
        ...
        // execute_round_device_v_4_1_phase_1<<<
        //     num_blocks, 
        //     threads_per_block, 
        ...
        phase1_params.func = (void*) execute_round_device_v_4_1_phase_1;
        ...
        // up 
        // execute_round_device_v_4_1_phase_2_col_portion<<<
        ...
        phase2_up_params.func = (void*) execute_round_device_v_4_1_phase_2_col_portion;
        ...
        // left
        // execute_round_device_v_4_1_phase_2_row_portion<<<
        //     num_blocks, threads_per_block, 
        //     2*B*B*sizeof(int), 
        //     graph_stream>>>(dev_matrix, n, t, 0, t);

        cudaKernelNodeParams phase2_left_params = cuda_graph_node_params_copy(phase2_up_params);
        phase2_left_params.func = (void*) execute_round_device_v_4_1_phase_2_row_portion;
        ...
        phase2_right_params.func = (void*) execute_round_device_v_4_1_phase_2_row_portion;
        ...
        // up-left
        // execute_round_device_v_4_1_phase_3_portion<<<
        //     num_blocks, threads_per_block, 
        //     2*B*B*sizeof(int), 
        ...
        phase3_up_left_params.func = (void*) execute_round_device_v_4_1_phase_3_portion;
