...
//main device code
void floyd_warshall_blocked_device_v_2_1(int *matrix, int n, int B);

//rounds code
__global__ void execute_round_device_v_2_1_phase_1(int *matrix, int n, int t, bool handle_bank_conflict);
__global__ void execute_round_device_v_2_1_phase_2_row(int *matrix, int n, int t);
__global__ void execute_round_device_v_2_1_phase_2_col(int *matrix, int n, int t);
__global__ void execute_round_device_v_2_1_phase_3(int *matrix, int n, int t);

int main(int argc, char *argv[]) {

    return handle_arguments_and_execute(argc, argv, (void(*) (int*, int, int)) &floyd_warshall_blocked_device_v_2_1);
}
...
void floyd_warshall_blocked_device_v_2_1(int *matrix, int n, int B) {
    ...
    for(int t = 0; t < num_rounds; t++) { 
        ...
        execute_round_device_v_2_1_phase_1<<<
            num_blocks_phase_1, 
        ...
        execute_round_device_v_2_1_phase_2_row<<<num_rounds-1, threads_per_block_phase_1, 2*B*B*sizeof(int)>>>(dev_rand_matrix, n, t);
        execute_round_device_v_2_1_phase_2_col<<<num_rounds-1, threads_per_block_phase_1, 2*B*B*sizeof(int)>>>(dev_rand_matrix, n, t);
        ...
        execute_round_device_v_2_1_phase_3<<<num_blocks_phase_3, threads_per_block_phase_1, 2*B*B*sizeof(int)>>>(dev_rand_matrix, n, t);
        HANDLE_ERROR(cudaDeviceSynchronize()); 
    }
